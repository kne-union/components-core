const { default: FormInfo, Form, SubmitButton, SuperSelectTableList, fields } = _FormInfo;
        ...
        <FormInfo
          ...
          list={[
            <SuperSelectTableList
              ...
              columns={[
                { title: "课程名称", name: "name", span: 10 },
                { title: "技术方向", name: "category", span: 8 },
                { title: "课时", name: "duration", span: 6 },
              ]}
            />,
          ]}
        />
