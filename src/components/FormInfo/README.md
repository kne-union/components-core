...
const {Input, TextArea, Upload, Avatar, TypeDateRangePicker, Rate, Switch, Slider} = fields;
        ...
        <FormInfo
            ...
            >
                <Input
                    ...
                    tips="请输入姓名"
                />
            </ErrorTip>, <Input name="phone" label="手机" rule="REQ TEL"/>,
                <Input name="email" label="邮箱" rule="EMAIL"/>, <Upload name="file" label="文件" block/>,
                <Rate name="rate" label="评分"/>, <Switch name="switch" label="开关"/>,
                <Slider name="slider" label="滑动条"/>, <TypeDateRangePicker
                    name="type_date"
                    label="日期时间段"
                    rule="REQ"
                />, <TextArea name="des" label="备注" block/>, <SubmitButton>提交</SubmitButton>,]}
        />
    </Form>);
};
